  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        ...
        <a class="nav-link" href="profile.jsp"><span class="	fa fa-bell-o"></span> BLog <span class="sr-only">(current)</span></a>
      </li>
...
<%
	...
	User user=uDao.getUserByUserId(p.getUser_id());
				...
				<div class="row my-4">
					<div class="col-md-8 offset-md-2">
						<div class="card">
							...
							<div class="card-body my-3 row-user">
							<img class="card-img-top" src="blog_pic/<%=p.getP_pic() %>" alt="card image cap">
							<div class="row my-3"  >
								<div class="col-md-8 ">
									<p class="post-user-info"><a href="#"><%=user.getName().toUpperCase() %></a> has posted</p>
								</div>
								<div class="col-md-4">
									 <p class="post-date"><%=p.getP_date().toLocaleString() %></p>
								</div>
							</div>
								<p class="post-content"><b><%=p.getP_content() %></b></p>
								<br>
								<br>
								<pre > <%=p.getP_code() %></pre>
							</div>
