<nav class="navbar navbar-expand-lg navbar-dark primary-background">
 ...
 -->	  <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="register.jsp"><span class="fa fa-user-plus"></span></span> Signup</a>
      </li>
    </ul>
    <form class="form-inline my-2 my-lg-0">
      <input class="form-control mr-sm-2" type="search" placeholder="Search Here.." aria-label="Search">
      <button class="btn primary-background	 my-2 my-sm-0 text-white" type="submit"><span class="fa fa-search"></span> Search</button>
    </form>
  </div>
</nav>